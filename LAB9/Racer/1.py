...
background_image = pygame.image.load("C:/Users/user/Desktop/pp2/LAB8/Racer/Images/AnimatedStreet.png")
...
# background sound
pygame.mixer.music.load('C:/Users/user/Desktop/pp2/LAB9/Racer/Music/Lab 9_racer_music_back music.wav')
...
class Enemy(pygame.sprite.Sprite):
    ...
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("C:/Users/user/Desktop/pp2/LAB8/Racer/Images/Enemy.png")
...
class Player(pygame.sprite.Sprite):
    ...
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("C:/Users/user/Desktop/pp2/LAB8/Racer/Images/Player.png")
        self.rect = self.image.get_rect()
...
class Coin(pygame.sprite.Sprite):
    ...
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("C:/Users/user/Desktop/pp2/LAB8/Racer/Images/coin.png")
        self.rect = self.image.get_rect()
        self.rect.center = (random.randint(40, screen_width - 40), 0)
...
class BigCoin(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load('C:/Users/user/Desktop/pp2/LAB9/Racer/Images/red coin.png')
        self.rect = self.image.get_rect()
    def move(self):
        self.rect.move_ip(0, speed)
...
while True:
    # В основном игровом цикле добавьте вызов метода move() для игрока:
    for event in pygame.event.get():
        ...
        if event.type == QUIT:
            pygame.quit()
            sys.exit()
    player.move()  # Добавьте эту строку, чтобы обработать движение игрока

# После обновления всех спрайтов вызовите функцию обновления экрана:
    ...
    if pygame.sprite.spritecollideany(player, enemies):
        pygame.mixer.Sound('C:/Users/user/Desktop/pp2/LAB9/Racer/Music/Lab 9_racer_music_crash.wav').play()
        time.sleep(0.5)
