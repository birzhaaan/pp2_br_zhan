...
'''Каждый класс представляет собой различные элементы игры: точку на сетке, 
змею, еду и супереду соответственно. Каждый класс имеет методы для движения, отрисовки и обработки столкновений.'''
class Point:
...
while not done:  
    ...
    '''В этом цикле обрабатываются все события,
      такие как движение змеи, столкновения, изменение направления движения, а также активация супереды.'''
    screen.fill(GRAY)  
