...
bg = pg.image.load("C:/Users/user/Desktop/pp2/LAB8/Snake/Images/background.jpg")
bg = pg.transform.scale(bg, (w, h))
gameover = pg.image.load("C:/Users/user/Desktop/pp2/LAB8/Snake/Images/game_over.jpg")
...
class Food:
    def __init__(self):
        ...
        self.pic = pg.image.load("C:/Users/user/Desktop/pp2/LAB8/Snake/Images/cherry.png")
...
class Wall:
    def __init__(self, x, y):
        self.x, self.y = x, y
        self.pic = pg.image.load("C:/Users/user/Desktop/pp2/LAB8/Snake/Images/wall.png")
...
while is_running:
    ...
    my_walls = open(f'C:/Users/user/Desktop/pp2/LAB8/Snake/Wall txt files/wall{level}.txt', 'r').readlines()
    walls = []
