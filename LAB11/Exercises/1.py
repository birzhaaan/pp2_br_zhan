...
#Ex2
'''Code in 'PGAdmin' 
IF (SELECT * FROM adamdar WHERE surname = 'Orynbasar')
BEGIN
    -- Если пользователь существует, обновляем его данные
    UPDATE adamdar
    SET name = 'Bakhyt', t_number = 999999
    WHERE surname = 'Orynbasar';
END
ELSE
BEGIN
    -- Если пользователь не существует, добавляем нового пользователя
    INSERT INTO adamdar (surname, name, t_number)
...
#Ex5
'''Code in 'PGAdmin' 
DELETE FROM adamdar WHERE name = 'Birzhan' or t_number = 222222;
'''